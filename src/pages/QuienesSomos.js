function QuienesSomos() {
  return (
    <div style={{padding:"20px", textAlign:'center'}}>
      ...
      <p>
ModaLocalMX es un prototipo de sistema web desarrollado como proyecto académico con el objetivo de impulsar el comercio digital de productores locales de moda y calzado en México.
...
El proyecto se desarrolla aplicando la metodología ágil Scrum, permitiendo organizar el trabajo en etapas (Sprint) para construir de forma progresiva un sistema funcional.
      ...
      <ul>
        ...
        <li>Carlos Rubén Díaz Gutiérrez</li>
        <li>Victor Hugo de la Cruz Salazar</li>
      </ul>
    </div>
  );
}
